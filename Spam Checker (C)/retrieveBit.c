/*
 * Filename: retrieveBit.c
 * Author: Jialu Xu
 * Userid: cs30s219ci
 * Description: The function of retrieveBit().
 * Date: 2019.8.24
...
int retrieveBit (table_t * table, char * string){
    ...
    //get bit idx%8 of the char at index idx/8 in bitArray
    
    int result;
    result = table->bitArray[idx/EIGHT] & (1<<(idx%EIGHT));
